...
INSERT INTO "new_Task" ("completedAt", "completedChapters", "completedPomos", "createdAt", "description", "dueDate", "estimatedPomos", "id", "isLongTerm", "listId", "parentId", "priority", "sectionId", "sortOrder", "sourceTaskId", "status", "tags", "title", "totalChapters", "totalFocusTime", "updatedAt", "userId") SELECT "completedAt", "completedChapters", "completedPomos", "createdAt", "description", "dueDate", "estimatedPomos", "id", "isLongTerm", "listId", "parentId", "priority", "sectionId", "sortOrder", "sourceTaskId", "status", "tags", "title", "totalChapters", "totalFocusTime", "updatedAt", "userId" FROM "Task";
DROP TABLE "Task";
